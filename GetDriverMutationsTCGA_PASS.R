...
cohort.name = "TCGA_PASS_test"
SNV.folder = "/mnt/bmh01-rds/UoOxford_David_W/Arwa/SNV_Calls/PASS_TCGA_BRCA"
postscript = "-09.annot.muts.PASS.vcf.gz"
